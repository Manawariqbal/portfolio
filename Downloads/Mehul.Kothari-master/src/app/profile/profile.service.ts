...
export class ProfileService {
  ...
  about2 = `Software Developer  .

  Expertise in Angular  Javascript,  Node JS and UI with Responsive Designs .
  Have good understanding of Python, Jquery, Bootstrap,  and MYSQL`

  about = "Lover of innovation and everything related to generate new knowledge.Face problems with a smile and solve them as soon as possible. Very calculated about the time I spend and work I do."
  resumeurl = "https://drive.google.com/file/d/1h4Oakwk9uv09jESyDNK-s_qSaOzOSJiX/view?usp=sharing"
  ...
  educationData: any = [
    {
      ...
      'info': `Coochbehar Government Engineering College is affliated with Maulana Abul Kalam Azad University of Technology
      Persuing  B.Tech in Computer Science  Engineering currently 8.815 CGPA  
      Co-founder of Tech club Tech-o-Nics in College`,
      'institution': 'COOCHBEHAR GOVERNMENT ENGINEERING COLLEGE WEST BENGAL'
    },
    {
      'id': '2',
  ...
  exprienceData: any = [
    {
      ...
      company: 'INFYMAX ',
      location: 'KOLKATA',
      timeline: 'JANUARY 2022 to Present',
    ...
    },
    {
      ...
      company: 'Saathipads',
      location: 'Remote',
      timeline: 'September 2021 to Dec 2021',
      role: 'Web Developer Intern',
      work: `Technologies : HTML, CSS , Javascript. 
      Worked on creating website pages for saathipads.com .`
    },
